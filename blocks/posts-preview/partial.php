...
<div class="posts-preview <?php echo $args['classes'] ?>"<?php if($background_colour) : ?> style="background-color: <?php echo $background_colour ?>;"<?php endif; ?>>
  <div class="posts-preview__views container">
    ...
    <div class="posts-preview__view grid <?php echo $idx === 0 ? 'posts-preview__view--active' : '' ?>">
      <div class="posts-preview__meta grid__col--span3">
        ...
        <nav class="posts-preview__nav">
          <button class="posts-preview__nav-item" type="button">
      ...
      <video class="posts-preview__video grid__col--span8" playsinline autoplay muted loop>
          <source src="<?php echo get_field("featured_case_study_video", $post); ?>" type="video/mp4">
      </video>
    <?php else : ?>
      <a class="posts-preview__image-container grid__col--span8" href="<?php echo get_the_permalink($post) ?>" style="background-image: url('<?php echo get_the_post_thumbnail_url($post) ?>');">
      </a>
      <?php endif; ?>
    </div>
    <?php endforeach; ?>
