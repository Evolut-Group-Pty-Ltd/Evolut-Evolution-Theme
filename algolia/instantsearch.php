...
?>
	...
	<div id="ais-wrapper">
		<main id="ais-main">
      <div class="algolia-search__settings">
			  <div class="algolia-search-box-wrapper container">
		    ...
		    <aside id="ais-facets" class="container">
		    	<div class="ais-filter ais-filter--post-types">
		    		<h3 class="widgettitle"><?php esc_html_e( 'Filter By', 'wp-search-with-algolia' ); ?></h3>
		    		<section class="ais-facets" id="facet-post-types"></section>
		    	</div>
		    	<div class="ais-filter ais-filter--categories">
		    		<h3 class="widgettitle"><?php esc_html_e( 'Categories', 'wp-search-with-algolia' ); ?></h3>
		    		<section class="ais-facets" id="facet-categories"></section>
		    	</div>
		    	<div class="ais-filter ais-filter--tags">
		    		<h3 class="widgettitle"><?php esc_html_e( 'Tags', 'wp-search-with-algolia' ); ?></h3>
		    		<section class="ais-facets" id="facet-tags"></section>
		    	</div>
		    	<div class="ais-filter ais-filter--users">
			...
			<div class="algolia-search__results container" id="algolia-hits"></div>
			<div class="alholia-search__pagination" id="algolia-pagination"></div>
		</main>
	</div>

	<script type="text/html" id="tmpl-instantsearch-hit">
		<article class="ais-search-item" itemtype="http://schema.org/Article">
			...
			<div class="ais-hits--content">
				...
				<a href="{{ data.permalink }}" title="{{ data.post_title }}" class="ais-hits--footer-link">
