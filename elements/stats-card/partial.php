...
<?php endif; ?>
  <div class="stats-cards__item__container">
      ...
      <?php if($args['animation']) : ?>
        <div class="round-prog" style="--progress: <?php echo $stat_percent; ?>; --inactive-color: <?php echo $stat_bar_color; ?>; --active-color: <?php echo $stat_bg_color; ?>;">
          <svg width="100" height="100">
            <circle class="round-prog__bg" cx="40" cy="50" r="45"   transform="rotate(-90, 45, 45)"/>
            <circle class="round-prog__line" cx="40" cy="50" r="45" transform="rotate(-90, 45, 45)"/>
          </svg>
    ...
    <div class="stats-cards__item-content">
      <?php if($args['stat'] || $args['stat']==0) : ?><h5 class="stats-cards__item-title"><?php echo $args['before_number'] ?><span class="counter"><?php echo ($args['use_thousands_separator']) ? number_format($args['stat']) : $args['stat'] ?></span><?php echo $args['after_number'] ?></h5><?php endif; ?>
      <div class="stats-cards__item-text<?php if(!$args['stat']) : ?> no-stat<?php endif; ?>">
        <?php echo $args['text'] ?>
      </div>
    </div>
  </div>
